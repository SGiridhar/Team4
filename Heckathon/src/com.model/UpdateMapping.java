				...
				if(sql[j].toLowerCase().contains("where")&& j > sIndex && sIndex!=-1)
			{
				...
				for(int i=0; i<val.length;i++)
				{
					...
					//System.out.println(val3[0]+" ="+val3[1]);
							...
							WriteXlsx.WriteCol("Update",ID,values[0],values[1],val3[0],Sinfo[0],Sinfo[1],Sinfo[2],"JOIN");
							}
							upd++;
							}
							else
					...
					WriteXlsx.WriteCol("Update",ID,values[0],values[1],val3[0],Sinfo2[0],Sinfo2[1],Sinfo2[2],"NIL");
							upd++;
								}
								else if(sCol.toUpperCase().contains("CURRENT_TIMESTAMP(0)")||sCol.toUpperCase().contains("CTRL"))
								{
